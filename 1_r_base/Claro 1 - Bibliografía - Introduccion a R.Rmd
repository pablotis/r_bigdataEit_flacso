...
Con _R base_ nos referimos al set de funciones que vienen en el programa, sin necesidad de instalar nada extra. 
...
Los __Objetos/Elementos__ constituyen la categoría escencial del R. De hecho, todo en R puede ser un objeto. Un número, un vector, una función, la progresión de letras del abecedario, una base de datos, un gráfico, todos pueden ser guardados en objetos. Los objetos que vamos creando a medida que trabajamos pueden visualizarse en el _ambiente_, el cual figura en el panel derecho superior de la pantalla ("Environment").
...
**Valores de tipo numérico (`numeric`)**

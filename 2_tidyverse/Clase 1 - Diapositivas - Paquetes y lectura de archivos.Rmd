...
base_inmuebles <- read_csv(here("entradas", "inmuebles-estado-nacional.csv")) %>% 
...
knitr::include_graphics(here("1_r_base", "img", "invocacion.gif"))
...
knitr::include_graphics(here("1_r_base", "img", "tidyverse.png"))
```
]
...
knitr::include_graphics(here("1_r_base", "img", "circuito_del_dato.png"))
```
]
...
.pull-right[
```{r echo=FALSE, fig.align = 'center', out.width='100%'}
knitr::include_graphics(here("1_r_base", "img", "circuito_del_dato_tidy.png"))
```
]
...
Del paquete _{readr}_

- .csv --> _read_csv()_
- .txt --> _read_delim()_
- .xlsx (excel) --> Paquete _{readxl}_ --> _read_xlsx()_ o _read_excel()_

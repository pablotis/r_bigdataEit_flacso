...
base_covid <- readRDS(here("entradas", "base_covid_sample.RDS"))
```
...
knitr::include_graphics(here("3_tidyverse", "img", "tidyverse.png"))
```
]
...
knitr::include_graphics(here("3_tidyverse", "img", "circuito del dato.png"))
```
...
```r
base_covid <- read.table("entradas/base_covid_muestra.txt", sep = ",", header = T, fileEncoding = "UTF-8")
```
...
knitr::include_graphics(here("3_tidyverse", "img", "pipe.png"))
```
...
knitr::include_graphics(here("3_tidyverse", "img", "logo dplyr.png"))
```
...
knitr::include_graphics(here("3_tidyverse", "img", "select_presentacion.png"))
```
...
```r
base_codiv <- read.table("entradas/base_covid_muestra.txt", sep = ",", header = T, fileEncoding = "UTF-8")
```
...
knitr::include_graphics(here("3_tidyverse", "img", "selec_posicion.png"))
```
...
`r chunk_reveal("select_1", widths = c(1, 1.6), title = "# Otra forma de selecionar")`
...
`r chunk_reveal("select_2", widths = c(1, 1.6), title = "# Otra forma de selecionar")`
...
`r chunk_reveal("select_3", widths = c(1, 1.6), title = "# Otra forma de selecionar")`
...
`r chunk_reveal("select_4", widths = c(1, 1.6), title = "# Otra forma de selecionar")`
...
`r chunk_reveal("select_5", widths = c(1, 1.6), title = "# Otra forma de selecionar")`
...
3) Crear un objeto llamado __seleccion1__ cuyo contenido sea dos columnas de la base original, __seleccionadas según su nombre__

4) Crear un objeto llamado __seleccion2__ cuyo contenido sea dos columnas de la base original, __seleccionadas según su posición__

5) Crear un objeto llamado __selecicon3__ cuyo contenido sea las columnas en base a un cáracter específico en su nombre. Recordar las funciones _starts_with()_, _contains()_ y _ends_with()_
...
```{r echo=FALSE, fig.align = 'center', out.width='65%'}
knitr::include_graphics(here("3_tidyverse", "img", "filter_presentacion.png"))
```
...
`r chunk_reveal("filter", widths = c(1.2, 1.6), title = "# filter()")`
...
```{r mutate_0, eval = F, echo = F}
base_covid %>% 
  select(id_evento_caso, residencia_provincia_nombre) %>% #BREAK
  mutate(res_prov_nom_minus = tolower(residencia_provincia_nombre))
```


`r chunk_reveal("mutate_0", widths = c(1.7, 1.3), title="# mutate()")`
...
knitr::include_graphics(here("3_tidyverse", "img", "mutate_case.png"))
```
...
1) Recodificar la variable __edad__, en 4 rangos.
...
4) Completar los espacios en `_____` de la siguiente sentencia, con el fin de re-codificar la variable numérica __edad__ en 4 rangos:
...
```{r echo=FALSE, out.width = '30%', fig.align = 'center'}
knitr::include_graphics(here("3_tidyverse", "img", "logo tidyr.png"))
```
...
knitr::include_graphics(here("3_tidyverse", "img", "dato_ancho.png"))
```
...
```{r echo=FALSE, out.width = '80%', fig.align = 'center'}
knitr::include_graphics(here("3_tidyverse", "img", "dato_largo.png"))
```
